...
#Hilangkan saja tanda # untuk Pake token 
...
wait = {
   ...
   # "picturePath":"http://dl.profile.line.naver.jp",
    "Respontag":"Bakekok suka ngetag 👇👇👇",
    "welcome":"Selamat datang & betah",
    "comment":"Like like & like by ☆_̶̧̎̀̂̅̊_̵̢̣̞̘̣̞̺̮͉͖̻̍̈́̎̓̔̐̐͗̒̃̏̕_̷̢̧̲͔̠̜͖͇̦̟̞̗̬̋̎̎͂͋͛͘A̵̛̮̣̞͕͔͕̺̹̳͒͌̀̾̅̔̚R̸̯̤͐̎͑̀̌̔̋̔̊̾̔̄́̃ ̲I̸̧̟̞͓̥̼͇̺̥̯͋͐̓̋̓̓͛͝ ̳͈͕̳E̶ ̙͖̋̿͒̈́̓̕͠F̶̧͕̫̳̝͎̥̥̩̃͗̑̉̅̇̓́̍͘͘͜͝͝_̷̯͇͇̝̣͍̹̖̯͚͂͊̀̆͒̓̚͜ͅ_̶̞̱̥͖̤̣͓̬͈͚̫̼̼̩̲͆̈́͊̓̈̽̔̽̐̃͌̽́̀̚_̵̭͖̤̪̰̮͉̫͓̀͋̑͘☆",
    "message":"Terimakasih sudah add saya 😃\n☆| ☆_̶̧̎̀̂̅̊_̵̢̣̞̘̣̞̺̮͉͖̻̍̈́̎̓̔̐̐͗̒̃̏̕_̷̢̧̲͔̠̜͖͇̦̟̞̗̬̋̎̎͂͋͛͘A̵̛̮̣̞͕͔͕̺̹̳͒͌̀̾̅̔̚R̸̯̤͐̎͑̀̌̔̋̔̊̾̔̄́̃ ̲I̸̧̟̞͓̥̼͇̺̥̯͋͐̓̋̓̓͛͝ ̳͈͕̳E̶ ̙͖̋̿͒̈́̓̕͠F̶̧͕̫̳̝͎̥̥̩̃͗̑̉̅̇̓́̍͘͘͜͝͝_̷̯͇͇̝̣͍̹̖̯͚͂͊̀̆͒̓̚͜ͅ_̶̞̱̥͖̤̣͓̬͈͚̫̼̼̩̲͆̈́͊̓̈̽̔̽̐̃͌̽́̀̚_̵̭͖̤̪̰̮͉̫͓̀͋̑͘☆ |☆\n\nOpen Tikungan:\n┃🌀┃ 1 hari 1000c\n┃🌀┃ 1 minggu 2 juta 😁\n\nMinat?\nChat aja...",
    }
...
def sendMention(to, mid, firstmessage):
    try:
        ...
        bot = runtime(eltime)
        text += mention+"┃🌀┃ Jam : "+datetime.strftime(timeNow,'%H:%M:%S')+" Wib\n┃🌀┃ Group : "+str(len(gid))+"\n┃🌀┃ Teman : "+str(len(teman))+"\n┃🌀┃ Expired : In "+hari+"\n┃🌀┃ Version : ☆_̶̧̎̀̂̅̊_̵̢̣̞̘̣̞̺̮͉͖̻̍̈́̎̓̔̐̐͗̒̃̏̕_̷̢̧̲͔̠̜͖͇̦̟̞̗̬̋̎̎͂͋͛͘A̵̛̮̣̞͕͔͕̺̹̳͒͌̀̾̅̔̚R̸̯̤͐̎͑̀̌̔̋̔̊̾̔̄́̃ ̲I̸̧̟̞͓̥̼͇̺̥̯͋͐̓̋̓̓͛͝ ̳͈͕̳E̶ ̙͖̋̿͒̈́̓̕͠F̶̧͕̫̳̝͎̥̥̩̃͗̑̉̅̇̓́̍͘͘͜͝͝_̷̯͇͇̝̣͍̹̖̯͚͂͊̀̆͒̓̚͜ͅ_̶̞̱̥͖̤̣͓̬͈͚̫̼̼̩̲͆̈́͊̓̈̽̔̽̐̃͌̽́̀̚_̵̭͖̤̪̰̮͉̫͓̀͋̑͘☆\n┃🌀┃ Tanggal : "+datetime.strftime(timeNow,'%Y-%m-%d')+"\n┃🌀┃ Runtime : \n • "+bot
            ...
            if settings["unsendMessage"] == True:
                try:
                    ...
                    if msg_id in msg_dict:
                        if msg_dict[msg_id]["Mention"]:
                            contact = cl.getContact(msg_dict[msg_id]["Mention"])
                            ...
                            cl.sendImageWithURL(op.param1,[op.param2],image)
                except Exception as error:
                    logError(error)
               ...
               if msg.contentType == 13:
                 if wait["contact"] == True:
                    ...
                    if 'displayName' in msg.contentMetadata:
                        ...
                        path = cl.getContact(msg.contentMetadata["mid"]).picturePath
                        image = 'http://dl.profile.line.naver.jp'+path
                        cl.sendMessage(msg.to,"┃🌀┃ Nama : " + msg.contentMetadata["displayName"] + "\n┃🌀┃ MID : " + msg.contentMetadata["mid"] + "\n┃🌀┃ Status Msg : " + contact.statusMessage + "\n┃🌀┃ Picture URL : http://dl.profile.line.naver.jp" + contact.pictureStatus)
                        cl.sendImageWithURL(msg.to, image)
#ADD Bots
               if msg.contentType == 13:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                else: md+="┃🌀┃ Protectcancel「📴」\n ──┅━✥ ======= ✥━┅──\n╭━━━━━━━━━━━━━━━╮\n┃🌀☆̢̣̞̘̣̞̺̮͉͖̻̍̈́̎̓̔̐̐͗̒̃̏̕_̷̢̧̲͔̠̜͖͇̦̟̞̗̬̋̎̎͂͋͛͘A̵̛̮̣̞͕͔͕̺̹̳͒͌̀̾̅̔̚R̸̯̤͐̎͑̀̌̔̋̔̊̾̔̄́̃ ̲I̸̧̟̞͓̥̼͇̺̥̯͋͐̓̋̓̓͛͝ ̳͈͕̳E̶ ̙͖̋̿͒̈́̓̕͠F̶̧͕̫̳̝͎̥̥̩̃͗̑̉̅̇̓́̍͘͘͜͝͝_̷̯͇͇̝̣͍̹̖̯͚͂͊̀̆͒̓̚͜ͅ_̶̞̱̥͖̤̣͓̬͈͚̫͆̈́͊̓̈̽̔̽̐̃͌̽́̀̚ ̼̼̩̲_̵̭͖̤̪̰̮͉̫͓̀͋̑͘☆🌀┃\n╰━━━━━━━━━━━━━━━╯\n"                               
                                cl.sendMessage(msg.to, md+"\nTanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\nJam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                                 
                        elif cmd == "creator" or text.lower() == 'creator':
                            if msg._from in admin:
                                cl.sendText(msg.to,"Creator ☆_̶̧̎̀̂̅̊_̵̢̣̞̘̣̞̺̮͉͖̻̍̈́̎̓̔̐̐͗̒̃̏̕_̷̢̧̲͔̠̜͖͇̦̟̞̗̬̋̎̎͂͋͛͘A̵̛̮̣̞͕͔͕̺̹̳͒͌̀̾̅̔̚R̸̯̤͐̎͑̀̌̔̋̔̊̾̔̄́̃ ̲I̸̧̟̞͓̥̼͇̺̥̯͋͐̓̋̓̓͛͝ ̳͈͕̳E̶ ̙͖̋̿͒̈́̓̕͠F̶̧͕̫̳̝͎̥̥̩̃͗̑̉̅̇̓́̍͘͘͜͝͝_̷̯͇͇̝̣͍̹̖̯͚͂͊̀̆͒̓̚͜ͅ_̶̞̱̥͖̤̣͓̬͈͚̫̼̼̩̲͆̈́͊̓̈̽̔̽̐̃͌̽́̀̚_̵̭͖̤̪̰̮͉̫͓̀͋̑͘☆") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               cl.sendMessage1(msg)
                               rnd = ["Ini kontaknya Abang Boy yang cakep "]
                               p = random.choice(rnd)
                               lang = 'id'
                               tts = gTTS(text=p, lang=lang)
                               tts.save("hasil.mp3")
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                cl.sendMessage(msg.to, "┃🌀┃ ┃Ä̰̰́R̰̰̈́Ḭ̰̈́Ḛ̰̈́F̰̰̈́ ̰в̰̰̈́❍̰̰̈́т̰̰̈́ѕ̰̰̈́┃ Family Grup Info\n\n┃🌀┃ Nama Group : {}".format(G.name)+ "\n┃🌀┃ ID Group : {}".format(G.id)+ "\n┃🌀┃ Pembuat : {}".format(G.creator.displayName)+ "\n┃🌀┃ Waktu Dibuat : {}".format(str(timeCreated))+ "\n┃🌀┃ Jumlah Member : {}".format(str(len(G.members)))+ "\n┃🌀┃ Jumlah Pending : {}".format(gPending)+ "\n┃🌀┃ Group Qr : {}".format(gQr)+ "\n┃🌀┃ Group Ticket : {}".format(gTicket))
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                timeCreated = []
                                timeCreated.append(time.strftime("%d-%m-%Y [ %H:%M:%S ]", time.localtime(int(G.createdTime) / 1000)))
                                ret_ += "┃🌀┃ ┃Ä̰̰́R̰̰̈́Ḭ̰̈́Ḛ̰̈́F̰̰̈́ ̰в̰̰̈́❍̰̰̈́т̰̰̈́ѕ̰̰̈́┃ Family Grup Info\n"
                                ret_ += "\n┃🌀┃ Nama Group : {}".format(G.name)
                                ret_ += "\n┃🌀┃ ID Group : {}".format(G.id)
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"┃🌀┃ ┃☆_̶̧̎̀̂̅̊_̵̢̣̞̘̣̞̺̮͉͖̻̍̈́̎̓̔̐̐͗̒̃̏̕_̷̢̧̲͔̠̜͖͇̦̟̞̗̬̋̎̎͂͋͛͘A̵̛̮̣̞͕͔͕̺̹̳͒͌̀̾̅̔̚R̸̯̤͐̎͑̀̌̔̋̔̊̾̔̄́̃ ̲I̸̧̟̞͓̥̼͇̺̥̯͋͐̓̋̓̓͛͝ ̳͈͕̳E̶ ̙͖̋̿͒̈́̓̕͠F̶̧͕̫̳̝͎̥̥̩̃͗̑̉̅̇̓́̍͘͘͜͝͝_̷̯͇͇̝̣͍̹̖̯͚͂͊̀̆͒̓̚͜ͅ_̶̞̱̥͖̤̣͓̬͈͚̫̼̼̩̲͆̈́͊̓̈̽̔̽̐̃͌̽́̀̚_̵̭͖̤̪̰̮͉̫͓̀͋̑͘☆┃ Family bot\n\n"+ma+"\nTotal「%s」Family Bots" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"┃🌀┃ ┃☆_̶̧̎̀̂̅̊_̵̢̣̞̘̣̞̺̮͉͖̻̍̈́̎̓̔̐̐͗̒̃̏̕_̷̢̧̲͔̠̜͖͇̦̟̞̗̬̋̎̎͂͋͛͘A̵̛̮̣̞͕͔͕̺̹̳͒͌̀̾̅̔̚R̸̯̤͐̎͑̀̌̔̋̔̊̾̔̄́̃ ̲I̸̧̟̞͓̥̼͇̺̥̯͋͐̓̋̓̓͛͝ ̳͈͕̳E̶ ̙͖̋̿͒̈́̓̕͠F̶̧͕̫̳̝͎̥̥̩̃͗̑̉̅̇̓́̍͘͘͜͝͝_̷̯͇͇̝̣͍̹̖̯͚͂͊̀̆͒̓̚͜ͅ_̶̞̱̥͖̤̣͓̬͈͚̫̼̼̩̲͆̈́͊̓̈̽̔̽̐̃͌̽́̀̚_̵̭͖̤̪̰̮͉̫͓̀͋̑͘☆┃ Family admin\n\nSuper admin:\n"+ma+"\nAdmin:\n"+mb+"\nStaff:\n"+mc+"\nTotal「%s」Family Saints" %(str(len(owner)+len(admin)+len(staff))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"┃🌀┃ ┃☆_̶̧̎̀̂̅̊_̵̢̣̞̘̣̞̺̮͉͖̻̍̈́̎̓̔̐̐͗̒̃̏̕_̷̢̧̲͔̠̜͖͇̦̟̞̗̬̋̎̎͂͋͛͘A̵̛̮̣̞͕͔͕̺̹̳͒͌̀̾̅̔̚R̸̯̤͐̎͑̀̌̔̋̔̊̾̔̄́̃ ̲I̸̧̟̞͓̥̼͇̺̥̯͋͐̓̋̓̓͛͝ ̳͈͕̳E̶ ̙͖̋̿͒̈́̓̕͠F̶̧͕̫̳̝͎̥̥̩̃͗̑̉̅̇̓́̍͘͘͜͝͝_̷̯͇͇̝̣͍̹̖̯͚͂͊̀̆͒̓̚͜ͅ_̶̞̱̥͖̤̣͓̬͈͚̫̼̼̩̲͆̈́͊̓̈̽̔̽̐̃͌̽́̀̚_̵̭͖̤̪̰̮͉̫͓̀͋̑͘☆┃ Family Protection\n\n┃🌀┃ PROTECT URL :\n"+ma+"\n┃🌀┃ PROTECT KICK :\n"+mb+"\n┃🌀┃ PROTECT JOIN :\n"+md+"\n┃🌀┃ PROTECT CANCEL:\n"+mc+"\nTotal「%s」Grup yg dijaga" %(str(len(protectqr)+len(protectkick)+len(protectjoin)+len(protectcancel))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "┃🌀┃ ┃☆_̶̧̎̀̂̅̊_̵̢̣̞̘̣̞̺̮͉͖̻̍̈́̎̓̔̐̐͗̒̃̏̕_̷̢̧̲͔̠̜͖͇̦̟̞̗̬̋̎̎͂͋͛͘A̵̛̮̣̞͕͔͕̺̹̳͒͌̀̾̅̔̚R̸̯̤͐̎͑̀̌̔̋̔̊̾̔̄́̃ ̲I̸̧̟̞͓̥̼͇̺̥̯͋͐̓̋̓̓͛͝ ̳͈͕̳E̶ ̙͖̋̿͒̈́̓̕͠F̶̧͕̫̳̝͎̥̥̩̃͗̑̉̅̇̓́̍͘͘͜͝͝_̷̯͇͇̝̣͍̹̖̯͚͂͊̀̆͒̓̚͜ͅ_̶̞̱̥͖̤̣͓̬͈͚̫̼̼̩̲͆̈́͊̓̈̽̔̽̐̃͌̽́̀̚_̵̭͖̤̪̰̮͉̫͓̀͋̑͘☆┃ Speed respon\n\n - Get Profile\n   %.10f\n - Get Contact\n   %.10f\n - Get Group\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))
                            ...
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                ...
                                for m_id in wait["blacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"┃🌀┃ ┃☆_̶̧̎̀̂̅̊_̵̢̣̞̘̣̞̺̮͉͖̻̍̈́̎̓̔̐̐͗̒̃̏̕_̷̢̧̲͔̠̜͖͇̦̟̞̗̬̋̎̎͂͋͛͘A̵̛̮̣̞͕͔͕̺̹̳͒͌̀̾̅̔̚R̸̯̤͐̎͑̀̌̔̋̔̊̾̔̄́̃ ̲I̸̧̟̞͓̥̼͇̺̥̯͋͐̓̋̓̓͛͝ ̳͈͕̳E̶ ̙͖̋̿͒̈́̓̕͠F̶̧͕̫̳̝͎̥̥̩̃͗̑̉̅̇̓́̍͘͘͜͝͝_̷̯͇͇̝̣͍̹̖̯͚͂͊̀̆͒̓̚͜ͅ_̶̞̱̥͖̤̣͓̬͈͚̫̼̼̩̲͆̈́͊̓̈̽̔̽̐̃͌̽́̀̚_̵̭͖̤̪̰̮͉̫͓̀͋̑͘☆┃ Blacklist User\n\n"+ma+"\nTotal「%s」Blacklist User" %(str(len(wait["blacklist"]))))
                            ...
                            if msg._from in admin:
                              if wait["Talkblacklist"] == {}:
                                ...
                                for m_id in wait["Talkblacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"┃🌀┃ ┃☆_̶̧̎̀̂̅̊_̵̢̣̞̘̣̞̺̮͉͖̻̍̈́̎̓̔̐̐͗̒̃̏̕_̷̢̧̲͔̠̜͖͇̦̟̞̗̬̋̎̎͂͋͛͘A̵̛̮̣̞͕͔͕̺̹̳͒͌̀̾̅̔̚R̸̯̤͐̎͑̀̌̔̋̔̊̾̔̄́̃ ̲I̸̧̟̞͓̥̼͇̺̥̯͋͐̓̋̓̓͛͝ ̳͈͕̳E̶ ̙͖̋̿͒̈́̓̕͠F̶̧͕̫̳̝͎̥̥̩̃͗̑̉̅̇̓́̍͘͘͜͝͝_̷̯͇͇̝̣͍̹̖̯͚͂͊̀̆͒̓̚͜ͅ_̶̞̱̥͖̤̣͓̬͈͚̫̼̼̩̲͆̈́͊̓̈̽̔̽̐̃͌̽́̀̚_̵̭͖̤̪̰̮͉̫͓̀͋̑͘☆┃ Talkban User\n\n"+ma+"\nTotal「%s」Talkban User" %(str(len(wait["Talkblacklist"]))))
