                  ...
                  if wait["invite"] == True:
                    ...
                    for s in groups.members:
                        if invite in wait["blacklist"]:
                            cl.sendMessage(msg.to, "ãAwas kikil boss... hpus daftar bl dulu baru invite lagi bossã")
                            break
                        else:
               ...
               if msg.contentType == 0:
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               sendMention(msg.to, sender, "「 Type Selfbot 5 asist 」\n")
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"┃🌀┃ ┃☆_̶̧̎̀̂̅̊_̵̢̣̞̘̣̞̺̮͉͖̻̍̈́̎̓̔̐̐͗̒̃̏̕_̷̢̧̲͔̠̜͖͇̦̟̞̗̬̋̎̎͂͋͛͘A̵̛̮̣̞͕͔͕̺̹̳͒͌̀̾̅̔̚R̸̯̤͐̎͑̀̌̔̋̔̊̾̔̄́̃ ̲I̸̧̟̞͓̥̼͇̺̥̯͋͐̓̋̓̓͛͝ ̳͈͕̳E̶ ̙͖̋̿͒̈́̓̕͠F̶̧͕̫̳̝͎̥̥̩̃͗̑̉̅̇̓́̍͘͘͜͝͝_̷̯͇͇̝̣͍̹̖̯͚͂͊̀̆͒̓̚͜ͅ_̶̞̱̥͖̤̣͓̬͈͚̫̼̼̩̲͆̈́͊̓̈̽̔̽̐̃͌̽́̀̚_̵̭͖̤̪̰̮͉̫͓̀͋̑͘☆┃ Boy_Fira bot\n\n"+ma+"\nTotal「%s」Boy_Fira Bots" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"┃🌀┃ ┃☆_̶̧̎̀̂̅̊_̵̢̣̞̘̣̞̺̮͉͖̻̍̈́̎̓̔̐̐͗̒̃̏̕_̷̢̧̲͔̠̜͖͇̦̟̞̗̬̋̎̎͂͋͛͘A̵̛̮̣̞͕͔͕̺̹̳͒͌̀̾̅̔̚R̸̯̤͐̎͑̀̌̔̋̔̊̾̔̄́̃ ̲I̸̧̟̞͓̥̼͇̺̥̯͋͐̓̋̓̓͛͝ ̳͈͕̳E̶ ̙͖̋̿͒̈́̓̕͠F̶̧͕̫̳̝͎̥̥̩̃͗̑̉̅̇̓́̍͘͘͜͝͝_̷̯͇͇̝̣͍̹̖̯͚͂͊̀̆͒̓̚͜ͅ_̶̞̱̥͖̤̣͓̬͈͚̫̼̼̩̲͆̈́͊̓̈̽̔̽̐̃͌̽́̀̚_̵̭͖̤̪̰̮͉̫͓̀͋̑͘☆┃ Boy_Fira admin\n\nSuper admin:\n"+ma+"\nAdmin:\n"+mb+"\nStaff:\n"+mc+"\nTotal「%s」Boy_Fira*" %(str(len(owner)+len(admin)+len(staff))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"┃🌀┃ ┃☆_̶̧̎̀̂̅̊_̵̢̣̞̘̣̞̺̮͉͖̻̍̈́̎̓̔̐̐͗̒̃̏̕_̷̢̧̲͔̠̜͖͇̦̟̞̗̬̋̎̎͂͋͛͘A̵̛̮̣̞͕͔͕̺̹̳͒͌̀̾̅̔̚R̸̯̤͐̎͑̀̌̔̋̔̊̾̔̄́̃ ̲I̸̧̟̞͓̥̼͇̺̥̯͋͐̓̋̓̓͛͝ ̳͈͕̳E̶ ̙͖̋̿͒̈́̓̕͠F̶̧͕̫̳̝͎̥̥̩̃͗̑̉̅̇̓́̍͘͘͜͝͝_̷̯͇͇̝̣͍̹̖̯͚͂͊̀̆͒̓̚͜ͅ_̶̞̱̥͖̤̣͓̬͈͚̫̼̼̩̲͆̈́͊̓̈̽̔̽̐̃͌̽́̀̚_̵̭͖̤̪̰̮͉̫͓̀͋̑͘☆┃ Boy_Fira Protection\n\n┃🌀┃ PROTECT URL :\n"+ma+"\n┃🌀┃ PROTECT KICK :\n"+mb+"\n┃🌀┃ PROTECT JOIN :\n"+md+"\n┃🌀┃ PROTECT CANCEL:\n"+mc+"\nTotal「%s」Grup yg dijaga" %(str(len(protectqr)+len(protectkick)+len(protectjoin)+len(protectcancel))))
