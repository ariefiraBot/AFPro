...
def siderMembers(to, mid):
    try:
        ...
        cl.sendMessage(to, None, contentMetadata={"STKID":"12792058","STKPKGID":"1316973","STKVER":"1"}, contentType=7)
    except Exception as error:
        cl.sendMessage(msg.to, None, contentMetadata={"STKID":"12792062","STKPKGID":"1316973","STKVER":"1"}, contentType=7)
...
def welcomeMembers(to, mid):
    try:
        ...
        cl.sendMessage(msg.to, None, contentMetadata={"STKID":"41025179","STKPKGID":"3410176","STKVER":"1"}, contentType=7)
...
def Self():
    key = Setmain["keyCommand"]
    key = key.title()
    SelfMessage = "╭✥ ☆_̶̧̎̀̂̅̊_̵̢̣̞̘̣̞̺̮͉͖̻̍̈́̎̓̔̐̐͗̒̃̏̕_̷̢̧̲͔̠̜͖͇̦̟̞̗̬̋̎̎͂͋͛͘A̵̛̮̣̞͕͔͕̺̹̳͒͌̀̾̅̔̚R̸̯̤͐̎͑̀̌̔̋̔̊̾̔̄́̃ ̲I̸̧̟̞͓̥̼͇̺̥̯͋͐̓̋̓̓͛͝ ̳͈͕̳E̶ ̙͖̋̿͒̈́̓̕͠F̶̧͕̫̳̝͎̥̥̩̃͗̑̉̅̇̓́̍͘͘͜͝͝_̷̯͇͇̝̣͍̹̖̯͚͂͊̀̆͒̓̚͜ͅ_̶̞̱̥͖̤̣͓̬͈͚̫̼̼̩̲͆̈́͊̓̈̽̔̽̐̃͌̽́̀̚_̵̭͖̤̪̰̮͉̫͓̀͋̑͘☆✥╮\n│Not Using key「 " + key + " 」\n" + \
                  "╠❂➣" + key + "Blc\n" + \
                  "╠❂➣" + key + "Ban:on\n" + \
                  "╠❂➣" + key + "Unban:on\n" + \
                  "╠❂➣" + key + "Ban「@」\n" + \
            ...
            if Dmid in op.param3:
                if wait["autoJoin"] == True:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        kb.acceptGroupInvitation(op.param1)
                        ginfo = kc.getGroup(op.param1)
                        kb.sendMessage(op.param1,"Assalamualaikum 🙏" + str(ginfo.name))     
                 ...
                 if wait["detectMention"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ...
                           rnd = ["Ngetag mele ntar beper gak ada yang tanggung jawab.. jangan sampek puskun ya beb"]
                           p = random.choice(rnd)
                           lang = 'id'
                           tts = gTTS(text=p, lang=lang)
                           tts.save("hasil.mp3")
                           cl.sendAudio(msg.to,"hasil.mp3")
                           cl.sendMessage(msg.to, None, contentMetadata={"STKID":"12792059","STKPKGID":"1316973","STKVER":"1"}, contentType=7)
                           break
               if 'MENTION' in msg.contentMetadata.keys() != None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                tz = pytz.timezone("Asia/Jakarta")
                                timeNow = datetime.now(tz=tz)
                                md = "╭✥ ☆_̶̧̎̀̂̅̊_̵̢̣̞̘̣̞̺̮͉͖̻̍̈́̎̓̔̐̐͗̒̃̏̕_̷̢̧̲͔̠̜͖͇̦̟̞̗̬̋̎̎͂͋͛͘A̵̛̮̣̞͕͔͕̺̹̳͒͌̀̾̅̔̚R̸̯̤͐̎͑̀̌̔̋̔̊̾̔̄́̃ ̲I̸̧̟̞͓̥̼͇̺̥̯͋͐̓̋̓̓͛͝ ̳͈͕̳E̶ ̙͖̋̿͒̈́̓̕͠F̶̧͕̫̳̝͎̥̥̩̃͗̑̉̅̇̓́̍͘͘͜͝͝_̷̯͇͇̝̣͍̹̖̯͚͂͊̀̆͒̓̚͜ͅ_̶̞̱̥͖̤̣͓̬͈͚̫̼̼̩̲͆̈́͊̓̈̽̔̽̐̃͌̽́̀̚_̵̭͖̤̪̰̮͉̫͓̀͋̑͘☆✥╮\n│Tanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\n│Jam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]\n╰───────────────\n    •─{Protect Status}─•\n╭───────────────\n"
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"✒ Boy-FirA™️ admin\n\nSuper admin:\n"+ma+"\nAdmin:\n"+mb+"\nStaff:\n"+mc+"\nTotal「%s」Boy-FirA™️ staff" %(str(len(owner)+len(admin)+len(staff))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ...
                                    cl.sendMessage(msg.to,"Grup"+str(ginfo.name)+" pasukan sdah di luar om")
                                except:
                                    pass
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                try:
                                    ...
                                    cl.sendMessage(msg.to,"Grup "+str(ginfo.name)+"ã Aman Dari JS")
                                except:
                                    pass             
...
#===========Hiburan============#
                           ...
                           if msg._from in admin:
                               ...
                               with requests.session() as web:
                                ...
                                if len(cond) == 1:
                                    ...
                                    ret_ += "\n\nUntuk Melihat Details Music, silahkan gunakan command {}SearchMusic {}|ãnumberã".format(str(setKey), str(search))
                                    cl.sendMessage(to, str(ret_))
                                elif len(cond) == 2:
                                    num = int(cond[1])
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                                ...
                                num =  int(strnum)
                                wait["limit"] = num
                                cl.sendMessage(msg.to,"Total 📲 ❂➣ " +strnum)
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                             if msg.toType == 2:
                                ...
                                jmlh = int(wait["limit"])
                                cl.sendMessage(msg.to, "Berhasil ❂➣🔔 {} 📲 Grup".format(str(wait["limit"])))
                                if jmlh <= 100000:
                                  for x in range(jmlh):
                                     try:
